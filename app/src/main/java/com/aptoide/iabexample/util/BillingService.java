...
public interface BillingService {
  ...
  int isBillingSupported(int apiVersion, String packageName, String type) throws
      RemoteException ;

  Bundle getSkuDetails(int apiVersion, String packageName, String type, Bundle skusBundle) throws
      RemoteException ;

  Bundle getBuyIntent(int apiVersion, String packageName, String sku, String type, String developerPayload) throws
      RemoteException ;
  ...
  int stub(int apiVersion, String packageName, String type) throws
      RemoteException ;
