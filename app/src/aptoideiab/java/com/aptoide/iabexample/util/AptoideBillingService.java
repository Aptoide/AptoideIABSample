 ...
 */
class AptoideBillingService implements BillingService {

  private final AptoideInAppBillingService service;

  public AptoideBillingService(IBinder service) {
    this.service = AptoideInAppBillingService.Stub.asInterface(service);
  }
